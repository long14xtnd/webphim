...
<head>
    ...
    <link rel='stylesheet' id='bootstrap-css' href='{{ url('public/css/bootstrap.min.css?ver=5.7.2') }}' media='all'/>
    <link rel='stylesheet' id='style-css' href='{{ url('public/css/style.css?ver=5.7.2') }}' media='all'/>
    ...
    <div class="container">
        <div class="row" id="headwrap">
            <div class="col-md-3 col-sm-6 slogan">
                <p class="site-title"><a class="logo" href="{{ route('homepage') }}" title="phim hay ">Phim Hay</p></a>
                ...
                <div class="menu-menu_1-container">
                    <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        @foreach ($category as $cate)
                            <li class="mega"><a title="{{ $cate->title }}" href="{{ route('category',$cate->slug) }}">{{
                                    $cate->title }}</a></li>
                        @endforeach
                        ...
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($genre as $gen)
                                    <li><a title="{{ $gen->title }}" href="{{ route('genre',$gen->slug) }}">{{
                                            $gen->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($country as $coun)
                                    <li><a title="{{ $coun ->title }}" href="{{ route('country',$coun->slug) }}">{{
                                            $coun ->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
            ...
            <div class="widget about col-xs-12 col-sm-4 col-md-4">
                <div class="footer-logo">
                    <img class="img-responsive"
                         src="{{ asset('public/img/hailong.png') }}"
                         alt="Phim hay 2021- Xem phim hay nhất"/>
                </div>
                Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                               data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">longdoan14xtnd@gmail.com</a>
            </div>
        </div>
    </div>
</footer>
