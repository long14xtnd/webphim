                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a
                                        href="{{ route('category',$movie->category->slug) }}">{{ $movie->category->title }}</a> » <span><a
                    ...
                    <div class="halim-movie-wrapper">
                        ...
                        <div class="movie_info col-xs-12">
                            <div class="movie-poster col-md-3">
                                ...
                                @else
                                    <a id="watch_trailer" href="#watch_trailer" class="btn btn-primary"
                            ...
                            <div class="film-poster col-md-9">
                                ...
                                <ul class="list-info-group">
                                    ...
                                    @endif
                                    @if($movie->year!=Null)
                                        <li class="list-info-group-item"><span>Năm phát hành</span> : {{ $movie->year }}
                                        </li>
                                    @else
                                        <li class="list-info-group-item"><span>Năm phát hành</span> :Đang cập nhật
                                        </li>
                                    @endif
                                    ...
                                    <a class="halim-thumb"
                                       ...
                                       title="Đại Thánh Vô Song">
                                        <figure><img class="lazy img-responsive"
                                                     ...
                                                     alt="{{ $related->title }}" title="{{ $related->title }}"></figure>
                                        ...
                                        <div class="halim-post-title-box">
                                            <div class="halim-post-title ">
                                                ...
                                                <p class="original_title">{{ $related->eng_name }}</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
